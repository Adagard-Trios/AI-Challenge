...
# DATABASE_URL is optional here. Unset means a local SQLite file, which on a
# laptop is durable — unlike on Render. Back up backend/data/auth.db; it is
# then the only copy of your accounts.
```
