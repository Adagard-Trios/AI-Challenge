...
"""
        ...
        domain_insights.append(
            {
                ...
                "domain": "economical",
                "summary": f"Sri Lanka Economic Summary: {truncate(llm_summary, AGENT_SUMMARY_LIMIT)}",
                "severity": "medium",
                "impact_type": "risk",
            }
        )
    ...
    def aggregate_and_store_feeds(self, state: EconomicalAgentState) -> Dict[str, Any]:
        ...
        #
        # This was os.getenv("DATASET_PATH", "./datasets/economic_feeds") -- CWD-relative,
        ...
        dataset_dir = os.path.join(_dataset_root, "economic_feeds")
