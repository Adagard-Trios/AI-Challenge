...
from src.intelligence.summaries import build_summary, truncate, AGENT_SUMMARY_LIMIT
...
"""
        ...
        domain_insights.append(
            {
                ...
                "domain": "intelligence",
                "summary": f"📊 Business Intelligence Summary: {truncate(llm_summary, AGENT_SUMMARY_LIMIT)}",
                "severity": "medium",
                "impact_type": "risk",
                "is_llm_generated": True,
            }
    ...
    def aggregate_and_store_feeds(
        ...
        neo4j_manager = Neo4jManager(domain="intelligence")
        chroma_manager = ChromaDBManager(domain="intelligence")
        ...
        #
        # This was os.getenv("DATASET_PATH", "./datasets/intelligence_feeds") -- CWD-relative,
        ...
        dataset_dir = os.path.join(_dataset_root, "intelligence_feeds")
