...
"""
        ...
        domain_insights.append(
            {
                ...
                "domain": "meteorological",
                "summary": f"Sri Lanka Meteorological Summary: {truncate(llm_summary, AGENT_SUMMARY_LIMIT)}",
                "severity": "high" if change_detected else "medium",
                "impact_type": "risk",
            }
        )
    ...
    def aggregate_and_store_feeds(
        ...
        neo4j_manager = Neo4jManager(domain="meteorological")
        chroma_manager = ChromaDBManager(domain="meteorological")
