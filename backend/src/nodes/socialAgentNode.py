...
"""
        ...
        domain_insights.append(
            {
                ...
                "domain": "social",
                "summary": f"📊 Social Intelligence Summary: {truncate(llm_summary, AGENT_SUMMARY_LIMIT)}",
                "severity": "medium",
                "impact_type": "risk",
    ...
    def aggregate_and_store_feeds(self, state: SocialAgentState) -> Dict[str, Any]:
        ...
        neo4j_manager = Neo4jManager(domain="social")
        chroma_manager = ChromaDBManager(domain="social")
        ...
        #
        # This was os.getenv("DATASET_PATH", "./datasets/social_feeds") -- CWD-relative,
        ...
        dataset_dir = os.path.join(_dataset_root, "social_feeds")
