...
class DeviceConfig:
    ...
    def load(self) -> dict:
        ...
        try:
            ...
            # The file exists, so this is corruption or a permission problem,
            # not "no device paired" -- which is what {} tells every caller.
            logger.warning("[storage] %s exists but could not be read", self.path)
            return {}
