        ...
        <Routes>
          ...
          */}
          ...
          <Route
            path="/"
            element={
              /* Fallback is the landing page, not the login form: "/" is the
                 URL that gets shared, and it should say what Roger is before
                 asking for credentials. The form itself lives at /login. */
